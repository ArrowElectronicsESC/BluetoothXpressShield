...
const uint8_t swell[] = {0, 0, 0, 0, 0, 1, 5, 10, 20, 50, 90, 150, 255, 150, 90, 50, 20, 10, 5, 1, 0, 0, 0, 0}; //Used to test lights with a "chase effect" - Also used for the init section
...
void idleActions(void) {
    ...
    snprintf(print_buffer, 120,"Temp (Celcius) | Light (Lumens) | Light Value (R G B W/255)"
             ...
             int(ctemp), int(ctemp * 100) % 100, int(ambient),
